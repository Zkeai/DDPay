// Code generated by protoc-gen-go-geysergrpc. DO NOT EDIT.
// versions:
// - protoc-gen-go-geysergrpc v1.5.1
// - protoc             v3.19.6
// source: geyser.proto
...
// is compatible with the geysergrpc package it is being compiled against.
...
// It's only intended for direct use with geysergrpc.RegisterService,
